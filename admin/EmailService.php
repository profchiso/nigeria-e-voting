	...
	public function __construct()
	{
		...
		if (class_exists("\\Http\\Adapter\\Guzzle6\\Client")) {
            ...
            if(stripos($_SERVER['SERVER_NAME'], "127.0") !==FALSE){
                  $this->url="http://127.0.0.1/nigeria-e-voting/";
            }elseif(stripos($_SERVER['SERVER_NAME'], "local.") !==FALSE){
                  $this->url="http://localhost/nigeria-e-voting/";
            }else{
		...
		$message = '
			<table align="center" bgcolor="#ffffff" cellpadding="0" cellspacing="0" width="550">
				<tbody>
					<tr>
						 <td>
							<div style="padding:5px; text-align:center;background: #2F2F2F"><img alt="INEC LOGO" style="width:100%;max-width: 100px;" src="' . ($this->url) . 'img/coat_of_arms.jpg" /></div>
						</td>
					</tr>
					<tr>
						<td style="text-align:left">
						<div style="padding:20px 20px 3px 20px; color:white; text-align:left; font-family:Arial, sans-serif; color:#003b64; font-size:16px;" class="message_temp_body" >
							' .
							$email_data['message'] .
							'
						 </div>
